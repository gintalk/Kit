...
import com.vng.zing.media.livestation.service.thrift.TGetFullLiveProgramReq;
import com.vng.zing.media.livestation.service.thrift.client.TZMediaLiveStationServiceClient;
import com.vng.zing.media.livestream.mw.thrift.client.TZMediaLiveStreamMWClient;
import com.vng.zing.media.livestream.service.thrift.TGetLiveStreamReq;
import com.vng.zing.media.livestream.service.thrift.client.TZMediaLiveStreamServiceClient;

public class LivestreamServiceTest extends Test {

    private static final TZMediaLiveStreamServiceClient LIVESTREAM_SERVICE = TZMediaLiveStreamServiceClient.INST;
    private static final TZMediaLiveStreamMWClient LIVESTREAM_MW = TZMediaLiveStreamMWClient.INST;
    private static final TZMediaLiveStationServiceClient LIVE_STATION_SERVICE = TZMediaLiveStationServiceClient.INST;


    public static void main(String[] args) {
//        ThriftUtils.prettyPrint(LIVESTREAM_SERVICE.getLiveStream(new TGetLiveStreamReq()
//                .setStreamId(10443)
//        ).value);

        ThriftUtils.prettyPrint(LIVE_STATION_SERVICE.getFullLiveProgram(new TGetFullLiveProgramReq()
                .setId(25466)
        ).value);
