...
//        TLiveStream livestream = CLI.getLiveStream(10624).value;
...
//        System.out.println(CLI.selectPlayRequestMedia(new TLiveStreamMedia().setLivestreamId(10926).setMediaId(1073741852)));
        System.out.println(CLI.getListPromoteRequestMedia(new TLiveStreamGetListRequestMediaReq().setLivestreamId(10613).setStart(0).setCount(200)));
//        System.out.println(CLI.putRequestMedia(new TLiveStreamRequestMedia().setLivestreamId(10613).setMediaId(1073742064).setUserId(WhiteListUserUtils.NAMNH16)));
