...
public class CommentMWTest extends Test {
    ...
    public static void main(String[] args) {
        TComment value = DEF_MW_325.getComment(new TGetCommentMWReq()
                .setCommentId(20865736)
        ).value;
        System.out.println(value.numReply);

        value = DEF_MW_326.getComment(new TGetCommentMWReq()
                .setCommentId(20865736)
        ).value;
        System.out.println(value.numReply);
