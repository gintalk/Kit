...
import com.vng.zing.media.common.thrift.live.streaming.TLiveStreamGetListRequestMediaReq;
...
//        TLiveStream livestream = CLI.getLiveStream(10926).value;
//        livestream.addons = 2l;
//        System.out.println(CLI.putLiveStream(livestream));
//        System.out.println(ThriftUtils.getStructAsString(livestream));
//        System.out.println(CLI.putLiveStream(livestream.setProgramId(10105)));
        
//        TLiveStreamProgram program = CLI.getLiveStreamProgram(10143).value;
...
//        System.out.println(CLI.putRequestMediaToListPromote(new TLiveStreamMedia().setLivestreamId(10926).setMediaId(1073741852)));
...
//        System.out.println(CLI.putRequestMedia(new TLiveStreamRequestMedia().setLivestreamId(10926).setMediaId(1073742000).setUserId(NAMNH16_ZMP3_ID)));
        System.out.println(CLI.getListTopRequestMedia(new TLiveStreamGetListRequestMediaReq().setLivestreamId(10926).setStart(0).setCount(200)));
